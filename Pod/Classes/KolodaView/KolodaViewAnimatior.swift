...
open class KolodaViewAnimator {
    ...
    open func animateAppearanceWithCompletion(_ completion: AnimationCompletionBlock = nil) {
        ...
        kolodaAppearAlphaAnimation?.fromValue = NSNumber(value: 0.0 as Float)
        kolodaAppearAlphaAnimation?.toValue = NSNumber(value: 1.0 as Float)
    ...
    open func applyReverseAnimation(_ card: DraggableCardView, completion: AnimationCompletionBlock = nil) {
        ...
        firstCardAppearAnimation?.toValue = NSNumber(value: 1.0 as Float)
        firstCardAppearAnimation?.fromValue =  NSNumber(value: 0.0 as Float)
